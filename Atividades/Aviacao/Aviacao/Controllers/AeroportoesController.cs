...
namespace Aviacao.Controllers
{
    public class AeroportoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdAeroporto,Localizacao")] Aeroporto aeroporto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAeroporto,Localizacao")] Aeroporto aeroporto)
        {
